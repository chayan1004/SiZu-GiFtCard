    ...
    return (
      <div className="container mx-auto p-6 max-w-6xl">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">View your past gift card purchases</p>
        </div>
      ...
      <div className="container mx-auto p-6 max-w-6xl">
        <Card>
          <CardContent className="p-6 text-center">
            <p className="text-muted-foreground">Failed to load order history. Please try again later.</p>
            <Button 
              className="mt-4" 
